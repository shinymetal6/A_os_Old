...
#define USBD_MANUFACTURER_STRING    "StoneHEX"
#define USBD_PID_HS     			0x5710
#define USBD_PRODUCT_STRING_HS     "Aventador Virtual ComPort"
#define USBD_CONFIGURATION_STRING_HS     "CDC"
#define USBD_INTERFACE_STRING_HS     "CDC"
